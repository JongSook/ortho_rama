...
def xyzData():
    ...
    for i, points, analog in reader.read_frames():
        ...
        if moduleVar.get() == 1: # neck
            ...
            two_unit_x = angleUnitVector_2pt(points[0,0], points[0,1], points[0,2], points[3,0], points[3,1], points[3,2], 'x')
            two_unit_y = angleUnitVector_2pt(points[0,0], points[0,1], points[0,2], points[3,0], points[3,1], points[3,2], 'y')
            two_unit_z = (angleUnitVector_2pt(points[5,0], points[5,1], points[5,2], points[9,0], points[9,1], points[9,2], 'x') + angleUnitVector_2pt(points[5,0], points[5,1], points[5,2], points[7,0], points[7,1], points[7,2], 'x')) /2
            two_unit_0 = angleUnitVector_2pt(points[0,0], points[0,1], points[0,2], points[3,0], points[3,1], points[3,2], 'y')
            two_unit_a = angleUnitVector_2pt(points[0,0], points[0,1], points[0,2], points[4,0], points[4,1], points[4,2], 'x')
            two_unit_b = angleUnitVector_2pt(points[0,0], points[0,1], points[0,2], points[4,0], points[4,1], points[4,2], 'y')
            two_unit_c = (angleUnitVector_2pt(points[6,0], points[6,1], points[6,2], points[8,0], points[8,1], points[8,2], 'x') + angleUnitVector_2pt(points[6,0], points[6,1], points[6,2], points[10,0], points[10,1], points[10,2], 'x')) /2
            two_unit_d = angleUnitVector_2pt(points[0,0], points[0,1], points[0,2], points[4,0], points[4,1], points[4,2], 'y')
            df_deg = pd.DataFrame([[round(time,3), two_unit_x, two_unit_y, two_unit_z, two_unit_0, two_unit_a, two_unit_b, two_unit_c, two_unit_d]], index = [i], columns = ['Time (s)', 'R-FL/EXT', 'R-ADD/ABD', 'R-INT/EXT ROT', 'R-HOR ADD/ABD', 'L-FL/EXT', 'L-ADD/ABD', 'L-INT/EXT ROT', 'L-HOR ADD/ABD'])
            df_degXYZ = df_degXYZ.append(df_deg)
        elif moduleVar.get() == 5: # elbow
            two_unit_rx = (angleUnitVector_2pt(points[5,0], points[5,1], points[5,2], points[9,0], points[9,1], points[9,2], 'x') + angleUnitVector_2pt(points[5,0], points[5,1], points[5,2], points[7,0], points[7,1], points[7,2], 'x')) /2
            ...
            two_unit_lx = (angleUnitVector_2pt(points[6,0], points[6,1], points[6,2], points[8,0], points[8,1], points[8,2], 'x') + angleUnitVector_2pt(points[6,0], points[6,1], points[6,2], points[10,0], points[10,1], points[10,2], 'x')) /2
            ...
            two_unit_rx = (angleUnitVector_2pt(points[7,0], points[7,1], points[7,2], points[11,0], points[11,1], points[11,2], 'x') + angleUnitVector_2pt(points[9,0], points[9,1], points[9,2], points[12,0], points[12,1], points[12,2], 'x')) /2
            two_unit_ry = (angleUnitVector_2pt(points[7,0], points[7,1], points[7,2], points[11,0], points[11,1], points[11,2], 'x') + angleUnitVector_2pt(points[9,0], points[9,1], points[9,2], points[12,0], points[12,1], points[12,2], 'x')) /2
            two_unit_lx = (angleUnitVector_2pt(points[10,0], points[10,1], points[10,2], points[14,0], points[14,1], points[14,2], 'x') + angleUnitVector_2pt(points[8,0], points[8,1], points[8,2], points[13,0], points[13,1], points[13,2], 'x')) /2 
            two_unit_ly = (angleUnitVector_2pt(points[10,0], points[10,1], points[10,2], points[14,0], points[14,1], points[14,2], 'x') + angleUnitVector_2pt(points[8,0], points[8,1], points[8,2], points[13,0], points[13,1], points[13,2], 'x')) /2 
            df_deg = pd.DataFrame([[round(time,3), two_unit_rx, two_unit_ry, two_unit_lx, two_unit_ly]], index = [i], columns = ['Time (s)', 'R-FL/EXT', 'R-Radial/Ulnar', 'L-FL/EXT', 'L-Radial/Ulnar'])
            df_degXYZ = df_degXYZ.append(df_deg)
        else:
            print('Hello World')
    ...
    if moduleVar.get() == 1 or moduleVar.get() == 2:
        ...
        df_valueXYZ = df_degXYZ[df_degXYZ != 0]
        df_value = df_valueXYZ[['R-FL/EXT', 'R-ADD/ABD', 'R-INT/EXT ROT', 'R-HOR ADD/ABD', 'L-FL/EXT', 'L-ADD/ABD', 'L-INT/EXT ROT', 'L-HOR ADD/ABD']].agg(['min', 'max'])
    elif moduleVar.get() == 5:
        df_valueXYZ = df_degXYZ[df_degXYZ != 0]
        df_value = df_valueXYZ[['R-FL/EXT', 'R-PRO/SUP', 'L-FL/EXT', 'L-PRO/SUP']].agg(['min', 'max'])
    elif moduleVar.get() == 6:
        df_valueXYZ = df_degXYZ[df_degXYZ != 0]
        df_value = df_valueXYZ[['R-FL/EXT', 'R-Radial/Ulnar', 'L-FL/EXT', 'L-Radial/Ulnar']].agg(['min', 'max'])
    else:
        print('Hello World')
...
def savefile():
    ...
    with pd.ExcelWriter(saveName, engine='xlsxwriter') as writer:
        ...
        if moduleVar.get() == 1 or moduleVar.get() == 2:
            ...
            df_degXYZ.to_excel(writer, sheet_name='XYZ', index=True)
            df_value.to_excel(writer, sheet_name='XYZ', index=True, startcol=7)
            writer.sheets['XYZ'].set_column(2, 5, 15)
            writer.sheets['XYZ'].set_column(8, 11, 15)    
        elif moduleVar.get() == 4:
            df_degXYZ.to_excel(writer, sheet_name='XYZ', index=True)
            df_value.to_excel(writer, sheet_name='XYZ', index=True, startcol=11)
            writer.sheets['XYZ'].set_column(2, 9, 15)
            writer.sheets['XYZ'].set_column(12, 18, 15)
        elif moduleVar.get() == 5:
            df_degXYZ.to_excel(writer, sheet_name='XYZ', index=True)
            df_value.to_excel(writer, sheet_name='XYZ', index=True, startcol=7)
            writer.sheets['XYZ'].set_column(2, 5, 15)
        ...
        if moduleVar.get() == 1 or moduleVar.get() == 2:
            ...
            chart_a.add_series({'categories': ['XYZ', 1, 1, maxRow, 1], 'values': ['XYZ', 1, 5, maxRow, 5], 'line': {'color': '#0000FF', 'width': 1.2}})
            ...
            chart_x.set_size({'width': 360, 'height': 216})
            chart_x.set_plotarea({'layout': {'x': 0.13, 'y': 0.1, 'width': 0.82, 'height': 0.7}})
            worksheet.insert_chart('L5', chart_x)
            ...
            chart_y.set_size({'width': 360, 'height': 216})
            chart_y.set_plotarea({'layout': {'x': 0.13, 'y': 0.1, 'width': 0.82, 'height': 0.7}})
            worksheet.insert_chart('L16', chart_y)
            ...
            chart_z.set_size({'width': 360, 'height': 216})
            chart_z.set_plotarea({'layout': {'x': 0.13, 'y': 0.1, 'width': 0.82, 'height': 0.7}})
            worksheet.insert_chart('L27', chart_z)

            chart_0 = workbook.add_chart({'type': 'line'})
            chart_0.add_series({'categories': ['XYZ', 1, 1, maxRow, 1], 'values': ['XYZ', 1, 5, maxRow, 5], 'line': {'color': '#0000FF', 'width': 1.2}})
            chart_0.set_title({'name': 'Right Horizontal Adduction/Abduction', 'name_font': {'name': 'Time New Roman', 'bold': True, 'size': 14, 'color': 'black'}})
            ...
            worksheet.insert_chart('L38', chart_0)

            chart_a = workbook.add_chart({'type': 'line'})
            chart_a.add_series({'categories': ['XYZ', 1, 1, maxRow, 1], 'values': ['XYZ', 1, 6, maxRow, 6], 'line': {'color': '#0000FF', 'width': 1.2}})
            ...
            chart_a.set_size({'width': 360, 'height': 216})
            chart_a.set_plotarea({'layout': {'x': 0.13, 'y': 0.1, 'width': 0.82, 'height': 0.7}})
            worksheet.insert_chart('P5', chart_a)

            chart_b = workbook.add_chart({'type': 'line'})
            chart_b.add_series({'categories': ['XYZ', 1, 1, maxRow, 1], 'values': ['XYZ', 1, 7, maxRow, 7], 'line': {'color': '#0000FF', 'width': 1.2}})
            ...
            worksheet.insert_chart('P16', chart_b)

            chart_c = workbook.add_chart({'type': 'line'})
            chart_c.add_series({'categories': ['XYZ', 1, 1, maxRow, 1], 'values': ['XYZ', 1, 8, maxRow, 8], 'line': {'color': '#0000FF', 'width': 1.2}})
            chart_c.set_title({'name': 'Left Internal/External Rotation', 'name_font': {'name': 'Time New Roman', 'bold': True, 'size': 14, 'color': 'black'}})
            ...
            worksheet.insert_chart('P27', chart_c)

            chart_d = workbook.add_chart({'type': 'line'})
            chart_d.add_series({'categories': ['XYZ', 1, 1, maxRow, 1], 'values': ['XYZ', 1, 9, maxRow, 9], 'line': {'color': '#0000FF', 'width': 1.2}})
            chart_d.set_title({'name': 'Left Horizontal Adduction/Abduction', 'name_font': {'name': 'Time New Roman', 'bold': True, 'size': 14, 'color': 'black'}})
            ...
            worksheet.insert_chart('P38', chart_d)
        elif moduleVar.get() == 5:
            chart_x = workbook.add_chart({'type': 'line'})
            chart_x.add_series({'categories': ['XYZ', 1, 1, maxRow, 1], 'values': ['XYZ', 1, 2, maxRow, 2], 'line': {'color': '#0000FF', 'width': 1.2}})
            chart_x.set_title({'name': 'Right Flexion/Extension', 'name_font': {'name': 'Time New Roman', 'bold': True, 'size': 14, 'color': 'black'}})
            ...
            chart_a = workbook.add_chart({'type': 'line'})
            chart_a.add_series({'categories': ['XYZ', 1, 1, maxRow, 1], 'values': ['XYZ', 1, 5, maxRow, 5], 'line': {'color': '#0000FF', 'width': 1.2}})
            chart_a.set_title({'name': 'Left Radial/Ulnar', 'name_font': {'name': 'Time New Roman', 'bold': True, 'size': 14, 'color': 'black'}})
            chart_a.set_x_axis({'name': 'Motion Points (Samples)', 'name_font': {'name': 'Time New Roman', 'bold': False, 'size': 10, 'color': 'black'}, 'interval_unit': 120, 'label_position': 'low', 'line': {'none': True}})
            chart_a.set_y_axis({'name': 'Angles in Degree (°)', 'name_font': {'name': 'Time New Roman', 'bold': False, 'size': 10, 'color': 'black'}, 'major_gridlines': {'visible': False}})
            chart_a.set_legend({'position': 'none'})
            chart_a.set_size({'width': 360, 'height': 216})
