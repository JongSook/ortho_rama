...
path = 'D:\Document\Mahidol University\OrthoRama\Python\sample01\\Neck P khaew extension1.c3d'
...
for i, points, analog in reader.read_frames():
    for f in range(10):
        ...
        if f == 0:
            ...
            two_unit_x = angle_of_two_unit_vectors(points[4,0], points[4,1], points[4,2], points[2,0], points[2,1], points[2,2], 'x')
            two_unit_y = angle_of_two_unit_vectors(points[4,0], points[4,1], points[4,2], points[2,0], points[2,1], points[2,2], 'y')
            two_unit_z = angle_of_two_unit_vectors(points[4,0], points[4,1], points[4,2], points[2,0], points[2,1], points[2,2], 'z')
